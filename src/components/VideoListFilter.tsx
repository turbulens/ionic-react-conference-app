...
import './VideoListFilter.css'

import { connect } from '../data/connect';
import { updateFilteredTracks } from '../data/videos/videos.actions';
...
type VideoListFilterProps = OwnProps & StateProps & DispatchProps;

const VideoListFilter: React.FC<VideoListFilterProps> = ({ allTracks, filteredTracks, onDismissModal, updateFilteredTracks }) => {
